    ...
    <>
        ...
        <div style={css(`padding:18px 24px 40px;display:flex;flex-direction:column;min-height:760px;animation:ybup .35s ease`)}>
          <div style={css(`display:flex;justify-content:flex-end;position:relative`)}>
            ...
            {v.langOpen && (
              <div style={css(`position:absolute;top:34px;right:0;z-index:50;background:#fff;border:1px solid #ddeaf0;border-radius:14px;box-shadow:0 10px 24px rgba(25,86,88,.14);overflow:hidden;min-width:132px`)}>
                {v.langOptions.map((o) => (
                  <div key={o.code} onClick={o.onClick} style={css(`padding:10px 14px;font-size:13px;font-weight:${o.active ? 600 : 400};color:${o.active ? "#00708f" : "#25475a"};background:${o.active ? "#eaf6f8" : "#fff"};cursor:pointer;white-space:nowrap`)}>{o.label}</div>
                ))}
              </div>
            )}
          </div>
          <div style={css(`margin-top:34px;display:flex;flex-direction:column;align-items:center;gap:14px`)}>
            ...
            <div style={css(`text-align:center`)}>
              <div style={css(`font-size:24px;font-weight:700;line-height:1.25;color:#195658`)}>{v.t("Đăng nhập vào YooBook")}</div>
              <div style={css(`font-size:13px;color:#617789;margin-top:6px`)}>{v.t("Kho học liệu số Giáo Dục 3D/Vr360/XR")}</div>
            </div>
          </div>
          <div style={css(`margin-top:34px;display:flex;flex-direction:column;gap:16px`)}>
            <div style={css(`display:flex;flex-direction:column;gap:7px`)}>
              <label style={css(`font-size:13px;font-weight:500;color:#25475a`)}>{v.t("Email/Số điện thoại")}</label>
            ...
            <div style={css(`display:flex;flex-direction:column;gap:7px`)}>
              <label style={css(`font-size:13px;font-weight:500;color:#25475a`)}>{v.t("Mật khẩu")}</label>
              <div style={css(`display:flex;align-items:center;gap:10px;height:52px;padding:0 16px;border:1px solid #ddeaf0;border-radius:14px;background:#fff`)}>
                ...
                <span style={css(`flex:1;font-size:16px;letter-spacing:${v.showPassword ? "0.5px" : "3px"};color:#25475a`)}>{v.passwordMask}</span>
            ...
            <div style={css(`display:flex;align-items:center;justify-content:space-between`)}>
              <div onClick={v.toggleRemember} style={css(`display:flex;align-items:center;gap:8px;cursor:pointer`)}><div style={css(`width:18px;height:18px;border-radius:6px;background:${v.remember ? "#00aaab" : "#fff"};border:1px solid ${v.remember ? "#00aaab" : "#ddeaf0"};display:flex;align-items:center;justify-content:center`)}>{v.remember && <svg width="11" height="9" viewBox="0 0 11 9" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 4.6L4 7.6 10 1.4"/></svg>}</div><span style={css(`font-size:13px;color:#617789`)}>{v.t("Ghi nhớ mật khẩu")}</span></div>
              <span onClick={v.toForgotPassword} style={css(`font-size:13px;color:#00708f;font-weight:500;cursor:pointer`)}>{v.t("Quên mật khẩu")}</span>
            </div>
            ...
            <div style={css(`display:flex;align-items:center;gap:12px`)}><div style={css(`flex:1;height:1px;background:#ddeaf0`)}></div><span style={css(`font-size:12px;color:#617789`)}>{v.t("Hoặc")}</span><div style={css(`flex:1;height:1px;background:#ddeaf0`)}></div></div>
          ...
          <div style={css(`margin-top:auto;padding-top:28px;text-align:center;font-size:13px;color:#617789`)}>{v.t("Chưa có tài khoản?")} <span onClick={v.toSignup} style={css(`color:#00708f;font-weight:600;cursor:pointer`)}>{v.t("Đăng ký")}</span></div>
        </div>
      )}
      ...
      {v.isSignup && (
        <div style={css(`padding:18px 24px 40px;display:flex;flex-direction:column;min-height:760px;animation:ybup .35s ease`)}>
          ...
          <div style={css(`margin-top:20px;display:flex;flex-direction:column;align-items:center;gap:14px`)}>
            <img src="/assets/logo_new.svg" alt="YooBook" style={css(`height:44px;width:auto`)}/>
            <div style={css(`text-align:center`)}>
              <div style={css(`font-size:24px;font-weight:700;line-height:1.25;color:#195658`)}>{v.t("Tạo tài khoản YooBook")}</div>
              <div style={css(`font-size:13px;color:#617789;margin-top:6px`)}>{v.t("Bắt đầu khám phá kho học liệu số")}</div>
            </div>
          </div>
          <div style={css(`margin-top:28px;display:flex;flex-direction:column;gap:16px`)}>
            <div style={css(`display:flex;flex-direction:column;gap:7px`)}>
              <label style={css(`font-size:13px;font-weight:500;color:#25475a`)}>{v.t("Họ và tên")}</label>
              <div style={css(`display:flex;align-items:center;gap:10px;height:52px;padding:0 16px;border:1px solid #ddeaf0;border-radius:14px;background:#fff`)}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#617789" strokeWidth="1.7" strokeLinecap="round"><circle cx="12" cy="8" r="3.6"/><path d="M4.8 19.5c1.3-3.4 4-5.1 7.2-5.1s5.9 1.7 7.2 5.1"/></svg>
                <span style={css(`font-size:14px;color:#25475a`)}>Nguyễn Thị Hoa</span>
              </div>
            </div>
            <div style={css(`display:flex;flex-direction:column;gap:7px`)}>
              <label style={css(`font-size:13px;font-weight:500;color:#25475a`)}>{v.t("Email/Số điện thoại")}</label>
            ...
            <div style={css(`display:flex;flex-direction:column;gap:7px`)}>
              ...
              <div style={css(`display:flex;align-items:center;gap:10px;height:52px;padding:0 16px;border:1px solid #ddeaf0;border-radius:14px;background:#fff`)}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#617789" strokeWidth="1.7" strokeLinecap="round"><rect x="4.5" y="10.5" width="15" height="9.5" rx="2.6"/><path d="M8 10.5V7.8a4 4 0 0 1 8 0v2.7"/></svg>
                <span style={css(`flex:1;font-size:16px;letter-spacing:${v.signupShowPassword ? "0.5px" : "3px"};color:#25475a`)}>{v.signupPasswordMask}</span>
            ...
            <div style={css(`display:flex;flex-direction:column;gap:7px`)}>
              <label style={css(`font-size:13px;font-weight:500;color:#25475a`)}>{v.t("Xác nhận mật khẩu")}</label>
              <div style={css(`display:flex;align-items:center;gap:10px;height:52px;padding:0 16px;border:1px solid #ddeaf0;border-radius:14px;background:#fff`)}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#617789" strokeWidth="1.7" strokeLinecap="round"><rect x="4.5" y="10.5" width="15" height="9.5" rx="2.6"/><path d="M8 10.5V7.8a4 4 0 0 1 8 0v2.7"/></svg>
                <span style={css(`flex:1;font-size:16px;letter-spacing:${v.signupShowPassword ? "0.5px" : "3px"};color:#25475a`)}>{v.signupPasswordMask}</span>
              </div>
            ...
            <div onClick={v.toggleSignupAgree} style={css(`display:flex;align-items:flex-start;gap:8px;cursor:pointer`)}>
              ...
              <span style={css(`font-size:12.5px;line-height:1.5;color:#617789`)}>{v.t("Tôi đồng ý với Điều khoản dịch vụ và Chính sách bảo mật của YooBook")}</span>
            </div>
          ...
          <div style={css(`margin-top:auto;padding-top:28px;text-align:center;font-size:13px;color:#617789`)}>{v.t("Đã có tài khoản?")} <span onClick={v.toLogin} style={css(`color:#00708f;font-weight:600;cursor:pointer`)}>{v.t("Đăng nhập")}</span></div>
        </div>
      )}
      ...
      {v.isForgotPassword && (
        <div style={css(`padding:18px 24px 40px;display:flex;flex-direction:column;min-height:760px;animation:ybup .35s ease`)}>
          ...
          <div style={css(`margin-top:28px`)}>
            <div style={css(`font-size:23px;font-weight:700;color:#195658`)}>{v.t("Quên mật khẩu?")}</div>
            <div style={css(`font-size:13px;color:#617789;margin-top:8px;line-height:1.5`)}>{v.t("Nhập email hoặc số điện thoại đã đăng ký, chúng tôi sẽ gửi mã xác thực để đặt lại mật khẩu.")}</div>
          </div>
      ...
      {v.isVerification && (
        <div style={css(`padding:18px 24px 40px;display:flex;flex-direction:column;min-height:760px;animation:ybup .35s ease`)}>
          ...
          <div style={css(`margin-top:28px`)}>
            <div style={css(`font-size:23px;font-weight:700;color:#195658`)}>{v.t("Xác thực mã")}</div>
            <div style={css(`font-size:13px;color:#617789;margin-top:8px;line-height:1.5`)}>{v.t("Mã xác thực gồm 6 số đã được gửi tới")} hoa.nguyen@thpt-nguyenhue.edu.vn</div>
          </div>
          <div style={css(`margin-top:28px;display:flex;gap:9px;justify-content:space-between`)}>
            {"248160".split("").map((d, i) => (
              <div key={i} style={css(`flex:1;height:56px;border:1.6px solid ${i === 4 ? "#00aaab" : "#ddeaf0"};border-radius:14px;background:#fff;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:600;color:#195658`)}>{i < 4 ? d : ""}</div>
            ))}
          </div>
          <div style={css(`margin-top:20px;text-align:center;font-size:13px;color:#617789`)}>
            {v.canResendOtp ? (
              <span onClick={v.resendOtp} style={css(`color:#00708f;font-weight:600;cursor:pointer`)}>{v.t("Gửi lại mã")}</span>
            ) : (
              <>{v.t("Gửi lại mã sau")} <span style={css(`color:#195658;font-weight:600`)}>{v.otpClock}</span></>
            )}
          </div>
      ...
      {v.isNewPassword && (
        <div style={css(`padding:18px 24px 40px;display:flex;flex-direction:column;min-height:760px;animation:ybup .35s ease`)}>
          ...
          <div style={css(`margin-top:28px`)}>
            <div style={css(`font-size:23px;font-weight:700;color:#195658`)}>{v.t("Đặt lại mật khẩu")}</div>
            <div style={css(`font-size:13px;color:#617789;margin-top:8px;line-height:1.5`)}>{v.t("Tạo một mật khẩu mới, khác với các mật khẩu bạn đã dùng trước đó.")}</div>
          </div>
          <div style={css(`margin-top:28px;display:flex;flex-direction:column;gap:16px`)}>
            <div style={css(`display:flex;flex-direction:column;gap:7px`)}>
      ...
      {v.isSuccess && (
        <div style={css(`padding:18px 24px 40px;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:760px;animation:ybup .35s ease`)}>
          ...
          <div style={css(`margin-top:26px;text-align:center`)}>
            <div style={css(`font-size:22px;font-weight:700;color:#195658`)}>{v.t("Đổi mật khẩu thành công")}</div>
            <div style={css(`font-size:13px;color:#617789;margin-top:8px;line-height:1.5;max-width:260px`)}>{v.t("Mật khẩu của bạn đã được cập nhật. Hãy đăng nhập lại bằng mật khẩu mới.")}</div>
          </div>
      ...
      {v.isRole && (
        <div style={css(`padding:12px 24px 32px;animation:ybup .35s ease`)}>
          <div style={css(`text-align:center;margin-top:12px`)}>
            <div style={css(`font-size:23px;font-weight:700;color:#195658`)}>{v.t("Thiết lập YooBook")}</div>
            <div style={css(`font-size:13px;color:#617789;margin-top:6px;max-width:280px;margin-left:auto;margin-right:auto`)}>{v.t("Chọn vai trò để cá nhân hóa trải nghiệm của bạn")}</div>
          </div>
