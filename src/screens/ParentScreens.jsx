    ...
    <>
        ...
        <div style={css(`padding-bottom:120px;animation:ybup .3s ease`)}>
          <div style={css(`padding:6px 20px 20px;background:linear-gradient(180deg,#eaf6f8 0%,#fcfcfc 100%)`)}>
            <div style={css(`display:flex;align-items:center;justify-content:space-between`)}>
              <div><div style={css(`font-size:12px;color:#617789`)}>{v.t(`Phụ huynh`)}</div><div style={css(`font-size:17px;font-weight:700;color:#195658`)}>{v.parentName}</div></div>
          ...
          <div style={css(`padding:4px 20px 0`)}>
            <div style={css(`padding:16px;border:1px solid #ddeaf0;border-radius:20px;background:#fff`)}>
              <div style={css(`display:flex;align-items:center;justify-content:space-between`)}><span style={css(`font-size:13.5px;font-weight:600;color:#195658`)}>{v.t(`Tiến độ học tập`)}</span><span style={css(`font-size:13px;font-weight:700;color:#00708f`)}>{v.childPath}</span></div>
              ...
              <div style={css(`margin-top:9px;font-size:11.5px;color:#617789`)}>{v.childMissions} {v.t(`mission hoàn thành trong tuần này`)}</div>
            </div>
      ...
      {v.isPChild && (
        <div style={css(`padding:6px 20px 120px;animation:ybup .3s ease`)}>
          ...
          <div style={css(`margin-top:20px;font-size:14.5px;font-weight:600;color:#195658`)}>{v.t(`Kết quả theo lớp`)}</div>
          ...
          <div style={css(`margin-top:20px;font-size:14.5px;font-weight:600;color:#195658`)}>{v.t(`Bài tập gần đây`)}</div>
          <div style={css(`margin-top:12px;display:flex;flex-direction:column;gap:11px`)}>
      ...
      {v.isPReport && (
        <div style={css(`padding:6px 20px 120px;animation:ybup .3s ease`)}>
          <div style={css(`font-size:22px;font-weight:700;color:#195658`)}>{v.t(`Báo cáo tuần`)}</div>
          ...
          <div style={css(`margin-top:18px;display:flex;align-items:center;gap:8px`)}><div style={css(`width:8px;height:8px;border-radius:999px;background:#22c55e`)}></div><div style={css(`font-size:14px;font-weight:600;color:#195658`)}>{v.t(`Điểm mạnh`)}</div></div>
          ...
          <div style={css(`margin-top:18px;display:flex;align-items:center;gap:8px`)}><div style={css(`width:8px;height:8px;border-radius:999px;background:#f59e0b`)}></div><div style={css(`font-size:14px;font-weight:600;color:#195658`)}>{v.t(`Cần cải thiện`)}</div></div>
          <div style={css(`margin-top:10px;display:flex;flex-direction:column;gap:9px`)}>
      ...
      {v.isPMessages && (
        <div style={css(`padding:6px 20px 120px;animation:ybup .3s ease`)}>
          <div style={css(`display:flex;align-items:flex-start;justify-content:space-between`)}>
            <div><div style={css(`font-size:22px;font-weight:700;color:#195658`)}>{v.t(`Liên hệ giáo viên`)}</div><div style={css(`font-size:13px;color:#617789;margin-top:3px;text-wrap:pretty`)}>{v.t(`Gửi tin nhắn cho giáo viên đang dạy con và theo dõi phản hồi tại một nơi.`)}</div></div>
          </div>
      ...
      {v.isPThread && (
        <div style={css(`min-height:100%;display:flex;flex-direction:column;animation:ybup .3s ease`)}>
          <div style={css(`padding:6px 20px 14px;border-bottom:1px solid #ddeaf0;display:flex;align-items:center;gap:12px`)}>
            ...
            <div><div style={css(`font-size:14.5px;font-weight:600;color:#195658`)}>{v.t(`Cô Phạm Thu Trang`)}</div><div style={css(`font-size:11px;color:#617789`)}>{v.t(`SINH HỌC 8A1 · Trao đổi học tập`)}</div></div>
          </div>
          <div style={css(`flex:1;padding:16px 20px;display:flex;flex-direction:column;gap:12px`)}>
            ...
            {v.sent && (
              <div style={css(`display:flex;flex-direction:column;align-items:flex-end;animation:ybup .3s ease`)}>
                ...
                <span style={css(`font-size:10.5px;color:#8ba0ae;margin-top:5px`)}>{v.t(`Vừa gửi · đã gửi`)}</span>
              </div>
            )}
          </div>
          <div style={css(`padding:12px 20px 26px;border-top:1px solid #ddeaf0;display:flex;align-items:center;gap:10px;background:#fcfcfc`)}>
            <div style={css(`flex:1;min-height:48px;padding:13px 15px;border:1px solid #ddeaf0;border-radius:16px;background:#fff;font-size:13px;color:#8ba0ae`)}>{v.t(`Nhập nội dung tin nhắn...`)}</div>
      ...
      {v.isPSafety && (
        <div style={css(`padding:6px 20px 40px;animation:ybup .3s ease`)}>
          <div style={css(`display:flex;align-items:center;gap:12px`)}>
            ...
            <div style={css(`font-size:18px;font-weight:700;color:#195658`)}>{v.t(`Cài đặt an toàn`)}</div>
          </div>
          <div style={css(`margin-top:8px;font-size:12.5px;line-height:1.55;color:#617789;text-wrap:pretty`)}>{v.t(`Quản lý social, leaderboard, AI tutor và giới hạn thời gian học.`)}</div>
          ...
          <div style={css(`margin-top:20px;font-size:14px;font-weight:600;color:#195658`)}>{v.t(`Giới hạn màn hình mỗi ngày`)}</div>
          ...
          <div style={css(`margin-top:12px;padding:13px 14px;border-radius:14px;background:#edf7f9;font-size:12px;line-height:1.55;color:#617789;text-wrap:pretty`)}>{v.t(`Khi đạt giới hạn, con sẽ thấy thông báo “Hết thời gian sử dụng” và không thể tiếp tục học trong ngày.`)}</div>
