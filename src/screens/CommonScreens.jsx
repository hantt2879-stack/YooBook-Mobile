...
function ProfileField({ v, label, value }) {
  return v.profileEditing ? (
    <div style={css(`display:flex;flex-direction:column;gap:6px`)}>
      <label style={css(`font-size:12px;font-weight:500;color:#25475a`)}>{label}</label>
      <div style={css(`height:46px;padding:0 14px;border:1px solid #ddeaf0;border-radius:12px;background:#fff;display:flex;align-items:center;font-size:13.5px;color:#25475a`)}>{value}</div>
    </div>
  ) : (
    <div style={css(`display:flex;align-items:center;justify-content:space-between;gap:10px;padding:12px 14px;border-bottom:1px solid #edf7f9`)}>
      <span style={css(`font-size:12.5px;color:#617789;flex:none`)}>{label}</span>
      <span style={css(`font-size:13px;font-weight:600;color:#195658;text-align:right`)}>{value}</span>
    </div>
  );
}
    ...
    <>
      {v.isNoti && (
        <div style={css(`padding:6px 20px 120px;animation:ybup .3s ease`)}>
          <div style={css(`display:flex;align-items:center;justify-content:space-between`)}>
            <div><div style={css(`font-size:22px;font-weight:700;color:#195658`)}>{v.t(`Thông báo của bạn`)}</div><div style={css(`font-size:13px;color:#617789;margin-top:3px`)}>{v.hasUnreadNoti ? `${v.unreadNotiCount} ${v.t("thông báo chưa đọc")}` : v.t(`Bạn đã xem hết thông báo`)}</div></div>
        ...
        <div style={css(`padding:6px 20px 40px;animation:ybup .3s ease`)}>
          <div style={css(`display:flex;align-items:center;justify-content:space-between`)}>
            <div style={css(`display:flex;align-items:center;gap:12px`)}>
              ...
              <div style={css(`font-size:18px;font-weight:700;color:#195658`)}>{v.t(`Hồ sơ cá nhân`)}</div>
            </div>
          ...
          <div style={css(`margin-top:20px;display:flex;flex-direction:column;align-items:center;gap:10px`)}>
            ...
            <div style={css(`text-align:center`)}>
              <div style={css(`font-size:17px;font-weight:700;color:#195658`)}>{v.profileName}</div>
              <div style={css(`font-size:12.5px;color:#617789;margin-top:2px`)}>{v.roleLabel}</div>
            </div>
          </div>

          <div style={css(`margin-top:22px`)}>
            <div style={css(`font-size:13.5px;font-weight:600;color:#195658`)}>{v.t(`Thông tin cá nhân`)}</div>
            {v.profileEditing ? (
            ...
            <div style={css(`margin-top:${v.profileEditing ? "14" : "10"}px;padding:13px 14px;border:1px solid #ddeaf0;border-radius:16px;background:#fff`)}>
              <div style={css(`font-size:12px;color:#617789`)}>{v.t(`Giới thiệu`)}</div>
              {v.profileEditing ? (
                <div style={css(`margin-top:7px;min-height:70px;padding:10px 12px;border:1px solid #ddeaf0;border-radius:12px;background:#fff;font-size:12.5px;line-height:1.6;color:#25475a`)}>{v.profileBio}</div>
              ) : (
                <div style={css(`font-size:12.5px;line-height:1.6;color:#25475a;margin-top:5px;text-wrap:pretty`)}>{v.profileBio}</div>
              )}
            </div>
          </div>
          ...
          {!!v.profileRoleFields.length && (
            <div style={css(`margin-top:20px`)}>
              <div style={css(`font-size:13.5px;font-weight:600;color:#195658`)}>{v.profileRoleTitle}</div>
              {v.profileEditing ? (
                <div style={css(`margin-top:12px;display:flex;flex-direction:column;gap:14px`)}>
              ...
              <div style={css(`margin-top:10px;display:flex;flex-direction:column;gap:10px`)}>
                {v.profileChildren.map((c, i) => (
                  <div key={i} style={css(`display:flex;align-items:center;gap:12px;padding:12px 13px;border:1px solid #ddeaf0;border-radius:16px;background:#fff`)}>
                    ...
                    <div style={css(`flex:1;min-width:0`)}><div style={css(`font-size:13.5px;font-weight:600;color:#195658`)}>{c.name}</div><div style={css(`font-size:11.5px;color:#617789;margin-top:2px`)}>{c.meta}</div></div>
      ...
      {v.isChangePassword && (
        <div style={css(`padding:6px 20px 40px;animation:ybup .3s ease`)}>
          <div style={css(`display:flex;align-items:center;gap:12px`)}>
            ...
            <div style={css(`font-size:18px;font-weight:700;color:#195658`)}>{v.t(`Đổi mật khẩu`)}</div>
          </div>
          <div style={css(`margin-top:20px;display:flex;flex-direction:column;gap:16px`)}>
            <div style={css(`display:flex;flex-direction:column;gap:7px`)}>
              <label style={css(`font-size:13px;font-weight:500;color:#25475a`)}>{v.t(`Mật khẩu hiện tại`)}</label>
            ...
            <div style={css(`display:flex;flex-direction:column;gap:7px`)}>
              <label style={css(`font-size:13px;font-weight:500;color:#25475a`)}>{v.t(`Mật khẩu mới`)}</label>
              <div style={css(`display:flex;align-items:center;gap:10px;height:52px;padding:0 16px;border:1px solid #ddeaf0;border-radius:14px;background:#fff`)}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#617789" strokeWidth="1.7" strokeLinecap="round"><rect x="4.5" y="10.5" width="15" height="9.5" rx="2.6"/><path d="M8 10.5V7.8a4 4 0 0 1 8 0v2.7"/></svg>
                <span style={css(`flex:1;font-size:16px;letter-spacing:${v.newShowPassword ? "0.5px" : "3px"};color:#25475a`)}>{v.newPasswordMask}</span>
            ...
            <div style={css(`display:flex;flex-direction:column;gap:7px`)}>
              <label style={css(`font-size:13px;font-weight:500;color:#25475a`)}>{v.t(`Xác nhận mật khẩu mới`)}</label>
              <div style={css(`display:flex;align-items:center;gap:10px;height:52px;padding:0 16px;border:1px solid #ddeaf0;border-radius:14px;background:#fff`)}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#617789" strokeWidth="1.7" strokeLinecap="round"><rect x="4.5" y="10.5" width="15" height="9.5" rx="2.6"/><path d="M8 10.5V7.8a4 4 0 0 1 8 0v2.7"/></svg>
                <span style={css(`flex:1;font-size:16px;letter-spacing:${v.newShowPassword ? "0.5px" : "3px"};color:#25475a`)}>{v.newPasswordMask}</span>
              </div>
      ...
      {v.isWallet && (
        <div style={css(`padding:6px 20px 40px;animation:ybup .3s ease`)}>
          <div style={css(`display:flex;align-items:center;gap:12px`)}>
            <div onClick={v.toProfile} style={css(`width:38px;height:38px;border-radius:999px;border:1px solid #ddeaf0;background:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer`)}><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#195658" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 5L7.5 12l7 7"/></svg></div>
            <div style={css(`font-size:18px;font-weight:700;color:#195658`)}>{v.t(`Nạp tiền vào ví`)}</div>
          </div>
          ...
          <div style={css(`margin-top:22px;font-size:14.5px;font-weight:600;color:#195658`)}>{v.t(`Chọn mệnh giá`)}</div>
          ...
          <div style={css(`margin-top:22px;font-size:14.5px;font-weight:600;color:#195658`)}>{v.t(`Phương thức thanh toán`)}</div>
      ...
      {v.isServicePlan && (
        <div style={css(`padding:6px 20px 40px;animation:ybup .3s ease`)}>
          <div style={css(`display:flex;align-items:center;gap:12px`)}>
            <div onClick={v.toProfile} style={css(`width:38px;height:38px;border-radius:999px;border:1px solid #ddeaf0;background:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer`)}><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#195658" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 5L7.5 12l7 7"/></svg></div>
            <div style={css(`font-size:18px;font-weight:700;color:#195658`)}>{v.t(`Gói dịch vụ`)}</div>
          </div>
          ...
          <div style={css(`margin-top:20px;font-size:14.5px;font-weight:600;color:#195658`)}>{v.t(`Quyền lợi của bạn`)}</div>
          <div style={css(`margin-top:10px;display:flex;flex-direction:column;gap:9px`)}>
            {v.planFeatures.map((f, i) => (
              <div key={i} style={css(`display:flex;align-items:center;gap:10px;padding:12px 13px;border:1px solid #ddeaf0;border-radius:14px;background:#fff`)}>
                ...
                <span style={css(`font-size:12.5px;color:#25475a;line-height:1.4`)}>{f}</span>
              </div>
            ))}
          </div>

          <div style={css(`margin-top:20px;font-size:14.5px;font-weight:600;color:#195658`)}>{v.t(`Chọn gói`)}</div>
          <div style={css(`margin-top:10px;display:flex;flex-direction:column;gap:10px`)}>
            {v.planOptions.map((p, i) => (
              <div key={i} onClick={p.onClick} style={css(`display:flex;align-items:center;gap:12px;padding:14px;border:${p.selected ? "1.6px solid #00aaab" : "1px solid #ddeaf0"};background:${p.selected ? "#eaf6f8" : "#fff"};border-radius:16px;cursor:pointer;transition:all .15s`)}>
                ...
                <div style={css(`flex:1;min-width:0`)}>
                  <div style={css(`font-size:13.5px;font-weight:700;color:#195658`)}>{p.name}</div>
                  <div style={css(`font-size:11.5px;color:#617789;margin-top:2px;line-height:1.4`)}>{p.desc}</div>
                </div>
      ...
      {v.isDevices && (
        <div style={css(`padding:6px 20px 40px;animation:ybup .3s ease`)}>
          <div style={css(`display:flex;align-items:center;gap:12px`)}>
            <div onClick={v.toProfile} style={css(`width:38px;height:38px;border-radius:999px;border:1px solid #ddeaf0;background:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer`)}><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#195658" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 5L7.5 12l7 7"/></svg></div>
            <div style={css(`font-size:18px;font-weight:700;color:#195658`)}>{v.t(`Thiết bị của tôi`)}</div>
          </div>
          <div style={css(`margin-top:8px;font-size:12.5px;color:#617789;line-height:1.5`)}>{v.t(`Tối đa 3 thiết bị đăng nhập cùng lúc. Đăng xuất thiết bị không dùng để bảo vệ tài khoản.`)}</div>
          ...
          <div style={css(`margin-top:18px;display:flex;flex-direction:column;gap:10px`)}>
            {v.devices.map((d, i) => (
              <div key={i} style={css(`display:flex;align-items:center;gap:12px;padding:14px;border:1px solid #ddeaf0;border-radius:18px;background:#fff`)}>
                ...
                <div style={css(`flex:1;min-width:0`)}>
                  <div style={css(`font-size:13.5px;font-weight:600;color:#195658`)}>{d.name}</div>
                  <div style={css(`font-size:11.5px;color:#617789;margin-top:2px`)}>{d.loggedOut ? v.t(`Đã đăng xuất`) : d.meta}</div>
                </div>
          ...
          <div style={css(`margin-top:14px;padding:13px 14px;border-radius:14px;background:#edf7f9;font-size:12px;line-height:1.55;color:#617789;text-wrap:pretty`)}>{v.t(`Thêm thiết bị mới sẽ tự động xuất hiện ở đây sau khi đăng nhập.`)}</div>
        </div>
      )}
      ...
      {v.isNotifPrefs && (
        <div style={css(`padding:6px 20px 40px;animation:ybup .3s ease`)}>
          <div style={css(`display:flex;align-items:center;gap:12px`)}>
            <div onClick={v.toProfile} style={css(`width:38px;height:38px;border-radius:999px;border:1px solid #ddeaf0;background:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer`)}><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#195658" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 5L7.5 12l7 7"/></svg></div>
            <div style={css(`font-size:18px;font-weight:700;color:#195658`)}>{v.t(`Thông báo & tuỳ chọn`)}</div>
          </div>
      ...
      {v.isAccountSecurity && (
        <div style={css(`padding:6px 20px 40px;animation:ybup .3s ease`)}>
          <div style={css(`display:flex;align-items:center;gap:12px`)}>
            <div onClick={v.toProfile} style={css(`width:38px;height:38px;border-radius:999px;border:1px solid #ddeaf0;background:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer`)}><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#195658" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 5L7.5 12l7 7"/></svg></div>
            <div style={css(`font-size:18px;font-weight:700;color:#195658`)}>{v.t(`Tài khoản & bảo mật`)}</div>
          </div>

          <div style={css(`margin-top:18px;display:flex;flex-direction:column;gap:2px;border:1px solid #ddeaf0;border-radius:20px;background:#fff;overflow:hidden`)}>
            <div style={css(`display:flex;align-items:center;justify-content:space-between;gap:10px;padding:14px 16px;border-bottom:1px solid #edf7f9`)}><span style={css(`font-size:12.5px;color:#617789`)}>{v.t(`Email`)}</span><span style={css(`font-size:13px;font-weight:600;color:#195658`)}>{v.securityEmail}</span></div>
            <div style={css(`display:flex;align-items:center;justify-content:space-between;gap:10px;padding:14px 16px`)}><span style={css(`font-size:12.5px;color:#617789`)}>{v.t(`Trạng thái email`)}</span><span style={css(`height:22px;padding:0 9px;border-radius:999px;background:#f0fdf4;color:#15803d;font-size:10.5px;font-weight:600;display:flex;align-items:center`)}>{v.t(`Đã xác thực`)}</span></div>
          </div>
          ...
          <div onClick={v.toChangePassword} style={css(`margin-top:14px;display:flex;align-items:center;gap:13px;padding:15px 16px;border:1px solid #ddeaf0;border-radius:18px;background:#fff;cursor:pointer`)}>
            ...
            <div style={css(`flex:1`)}><div style={css(`font-size:14px;font-weight:500;color:#25475a`)}>{v.t(`Đổi mật khẩu`)}</div></div>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#8ba0ae" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.5 5l7 7-7 7"/></svg>
          </div>
          ...
          <div style={css(`margin-top:14px;display:flex;align-items:center;gap:12px;padding:15px;border:1px solid #ddeaf0;border-radius:18px;background:#fff`)}>
            <div style={css(`flex:1;min-width:0`)}><div style={css(`font-size:13.5px;font-weight:600;color:#195658`)}>{v.t(`Xác thực 2 lớp`)}</div><div style={css(`font-size:11.5px;color:#617789;margin-top:3px;line-height:1.45`)}>{v.t(`Thêm một lớp bảo vệ khi đăng nhập trên thiết bị mới`)}</div></div>
          ...
          <div onClick={v.toDevices} style={css(`margin-top:14px;display:flex;align-items:center;gap:13px;padding:15px 16px;border:1px solid #ddeaf0;border-radius:18px;background:#fff;cursor:pointer`)}>
            ...
            <div style={css(`flex:1`)}><div style={css(`font-size:14px;font-weight:500;color:#25475a`)}>{v.t(`Phiên đăng nhập & thiết bị`)}</div></div>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#8ba0ae" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.5 5l7 7-7 7"/></svg>
          </div>
      ...
      {v.isHelpSupport && (
        <div style={css(`padding:6px 20px 40px;animation:ybup .3s ease`)}>
          <div style={css(`display:flex;align-items:center;gap:12px`)}>
            <div onClick={v.toProfile} style={css(`width:38px;height:38px;border-radius:999px;border:1px solid #ddeaf0;background:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer`)}><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#195658" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 5L7.5 12l7 7"/></svg></div>
            <div style={css(`font-size:18px;font-weight:700;color:#195658`)}>{v.t(`Trợ giúp & hỗ trợ`)}</div>
          </div>
          ...
          <div style={css(`margin-top:18px;display:flex;flex-direction:column;gap:10px`)}>
            <div style={css(`display:flex;align-items:center;gap:12px;padding:14px;border:1px solid #ddeaf0;border-radius:16px;background:#fff`)}>
              ...
              <div style={css(`flex:1`)}><div style={css(`font-size:13px;font-weight:600;color:#195658`)}>{v.t(`Hotline hỗ trợ`)}</div><div style={css(`font-size:12px;color:#617789;margin-top:2px`)}>1900 6868</div></div>
            </div>
            <div style={css(`display:flex;align-items:center;gap:12px;padding:14px;border:1px solid #ddeaf0;border-radius:16px;background:#fff`)}>
              ...
              <div style={css(`flex:1`)}><div style={css(`font-size:13px;font-weight:600;color:#195658`)}>{v.t(`Email hỗ trợ`)}</div><div style={css(`font-size:12px;color:#617789;margin-top:2px`)}>support@yoobook.vn</div></div>
            </div>
          </div>

          <div style={css(`margin-top:22px;font-size:14.5px;font-weight:600;color:#195658`)}>{v.t(`Câu hỏi thường gặp`)}</div>
            ...
            {v.helpFaqs.map((f, i) => (
              <div key={i} onClick={f.onClick} style={css(`padding:14px;border:1px solid #ddeaf0;border-radius:16px;background:#fff;cursor:pointer`)}>
                <div style={css(`display:flex;align-items:center;justify-content:space-between;gap:10px`)}>
                  <span style={css(`font-size:13px;font-weight:600;color:#195658;line-height:1.4`)}>{f.q}</span>
                ...
                {f.open && (<div style={css(`font-size:12.5px;line-height:1.6;color:#617789;margin-top:9px;text-wrap:pretty`)}>{f.a}</div>)}
              </div>
            ))}
          </div>
