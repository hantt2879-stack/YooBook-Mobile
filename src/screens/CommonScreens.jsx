      ...
      {v.isNoti && (
        <div style={css(`padding:6px 20px 120px;animation:ybup .3s ease`)}>
          <div style={css(`display:flex;align-items:center;justify-content:space-between`)}>
            <div><div style={css(`font-size:22px;font-weight:700;color:#195658`)}>{v.t(`Thông báo của bạn`)}</div><div style={css(`font-size:13px;color:#617789;margin-top:3px`)}>{v.t(`3 thông báo chưa đọc`)}</div></div>
            <span style={css(`font-size:12.5px;color:#00708f;font-weight:500;cursor:pointer`)}>{v.t(`Đánh dấu đã đọc`)}</span>
          </div>
